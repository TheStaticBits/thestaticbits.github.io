...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'bin/debug/application.data';
...
Module['FS_createPath']("/", "res", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_bin/debug/application.data');

      };
      Module['addRunDependency']('datafile_bin/debug/application.data');
    ...
    loadPackage({"files": [{"filename": "/res/platform.png", "start": 0, "end": 131}, {"filename": "/res/player.png", "start": 131, "end": 398}], "remote_package_size": 398, "package_uuid": "43ed988a-44b2-4862-9e12-a194e84253f8"});
